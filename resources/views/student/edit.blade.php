                ...
                <div class="form-group">
                    ...
                    <select name="course_id" id="program" class="form-control" required>
                        @foreach (\App\Models\Course::all() as $course)
                            <option value="{{ $course->id }}" {{ $std->course_id == $course->id ? 'selected' : '' }}>
                                {{ $course->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="slot_id" id="time" class="form-control">
                        @foreach (\App\Models\Slot::all() as $slot)
                            <option value="{{ $slot->id }}" {{ $std->slot_id == $slot->id ? 'selected' : '' }}>
                                {{ $slot->time }}
                            </option>
                        @endforeach
                    </select>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $std->name }}" class="form-control" required placeholder="Name"
                        name="name" required>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input maxlength="10" minlength="8" type="text" class="form-control" required
                        placeholder="Phone number" name="phone" value="{{ $std->phone }}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="number" min="1" name="fmember" class="form-control" id="fmember" placeholder="Members"
                        value="{{ $std->fmember }}">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="occupation" class="form-control" placeholder="Occupation"
                        value="{{ $std->occupation }}">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="dealamount">Deal Amount</label>
                    <input type="number" min="0" name="dealamount" class="form-control" placeholder="Deal Amount"
                        required value="{{ $std->dealamount }}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="startfrom">Start Date</label>
                    <input type="text" name="startfrom" placeholder="Start Date" id="startfrom" required
                        class="form-control" value="{{ $std->startfrom }}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
